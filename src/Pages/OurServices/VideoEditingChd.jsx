      ...
      <section className="vec-hero">
        ...
        <div className="vec-hero__inner">
          <div className="vec-hero__left vec-animate">
            ...
            <div className="vec-hero__stats-inline">
          ...
          <div className="vec-hero__right vec-animate">
            <div 
              className="vec-video-preview"
              onMouseEnter={() => setIsVideoHovered(true)}
              onMouseLeave={() => setIsVideoHovered(false)}
            >
              <div className="vec-video-preview__inner">
                <div className="vec-video-preview__gradient" />
                <div className={`vec-play-button ${isVideoHovered ? 'vec-play-button--hover' : ''}`}>
                  <IconPlay />
                </div>
                <div className="vec-video-preview__label">Watch Showreel</div>
              </div>
              
              {/* Format Tags */}
              <div className="vec-format-tags">
                <div className="vec-format-tag">9:16</div>
                <div className="vec-format-tag">1:1</div>
                <div className="vec-format-tag">16:9</div>
                <div className="vec-format-tag">4:5</div>
              </div>
            </div>
          </div>
        </div>
